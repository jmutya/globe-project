// src/components/ReportedCreatedTable.js
import React, { useEffect, useState } from "react";
import * as XLSX from "xlsx";
import { saveAs } from "file-saver";
import { FaArrowUp, FaArrowDown } from "react-icons/fa";
import { getReportedAndCreatedData } from "../../backend/mtfunctions/mtttfunction";
...
const ReportedCreatedTable = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setIsLoading(true);
      try {
        const data = await getReportedAndCreatedData();
        setReportData(data);
      } catch (error) {
