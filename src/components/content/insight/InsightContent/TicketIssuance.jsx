      ...
      >
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-semibold mb-4">
            ...
            {selectedFilePrefix && selectedOpenedMonth
              ? `for tickets from "${selectedFilePrefix}" files opened in ${selectedOpenedMonth}`
              : selectedFilePrefix
              ? `for tickets from "${selectedFilePrefix}" files`
              : selectedOpenedMonth
              ? `for tickets opened in ${selectedOpenedMonth}`
              : "Overall"}
          </h3>
